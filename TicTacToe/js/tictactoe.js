...
let activePlayer = 'X';
//This array stores an array of moves. We use this to determine wind conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        audio('./media/new_place_sound.mp3');
    ...
    function computersTurn() {
        ...
        let pickASquare;
        //This condition allows our while loop to keep trying to if a square is selected already
        while (!success) {
...
function checkWinConditions() {
    ...
    //9 squares are selcted the code executes
    else if (selectedSquares.length >= 9) {
        //This function plays the tie game sound
        audio('./media/new_tie_sound.mp3');
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we pass are all included in our array the true is returned and our else if condition exectues the drawLine() function
...
function audio(audioURL) {
    ...
    //Play method plays our auido sound
    audio.play();
}
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        //This method starats a new path
        c.beginPath();
        ...
        c.strokeStyle = 'rgba(5, 255, 255, .8)';
        //This method draw everythin we laid out aboce
        c.stroke();
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) {y += 10; }
            //This condiition is similiar to the one above
